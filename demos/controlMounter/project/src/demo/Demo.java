...
import components.mounter.ControlMounter;

public class Demo extends Application {
	
	private static final String FXML_DOCUMENT_PATH = "resources/FXMLDocument.fxml";
	private static final String TITLE = "ControlMounter";
	private static final String DESCRIPTION = "Demo to show usage of ControlMounter component.\nIt was mounted over button below:\n - Tip \n - DoubleClickable\n - Movable.";
